...
- Name: tasks.spec.ts >> Edit a task via the Timeline modal >> clicking a task rect opens the edit modal pre-filled with the task title
- Location: tests/tasks.spec.ts:285:3
